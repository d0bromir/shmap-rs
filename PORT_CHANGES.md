...
> **Not merged.** Built, exact, and ACCEPT on the full suite, but worth only 1.037x end-to-end —
> not enough to justify the invariants it asks the port to carry. Kept on `q12-adaptive-theta`
> (PR #39); the decision and its reasoning are in RESULTS.md §5c. This section and §11 stay as the
> record of what was measured, because two of the findings outlive the change itself.
